...
public class EvilAutocorrectPrankTest {
    ...
    public void autocorrectbaYouUSister() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "You u youville utube you youyouyou uuu raiyou united youuuu u you"),
    ...
    public void autocorrectbaYou() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "I want to film the bayou with you and put it on youtube"),
    ...
    public void autocorrectYou() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "you"),"your sister" ,
    ...
    public void autocorrectU() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "u"),"your sister" ,
                EvilAutocorrectPrank.autocorrect("u"));
    }

    @Test
    public void autocorrectYouuu() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "youu"),"your sister" ,
...
//    }
    ...
    public void autocorrectIMissYouE() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "I miss you!"),"I miss your sister!" ,
    ...
    public void autocorrectYouAndOther() throws Exception {
        Assert.assertEquals(String.format("Wrong result for \"%s\":", "miss you"),"miss your sister" ,
    ...
    public void testApply() {
        ...
        for (int i = 0; i < inputs.length; i++) {
            Assert.assertEquals(String.format("Wrong result for \"%s\":", inputs[i]), outputs[i],
